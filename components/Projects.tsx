      ...
      */}
      ...
      >
        {items.map((item, index) => {
          ...
          const opacity = isActive ? 1 : Math.max(0.4, 1 - Math.abs(offset) * 0.3);
          ...
          return (
            ...
            >
              ...
              >
                 ...
                 {!isActive && (
                    <div className="absolute inset-0 bg-slate-950/50 pointer-events-none transition-colors duration-300 group-hover:bg-slate-950/20" />
                 )}
              </div>
            </div>
          );
